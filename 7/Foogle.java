// https://github.com/hunter-teacher-cert/csci70900-summer2021/blob/main/daily/7/Foogle.java
...
public class Foogle
{
  ...
  // old: foo
  // returns index of target element in al
  public static int findPosition( ArrayList al, int target )
  {
  ...
  // old: gizmo
  // rand[0,0), rand[0,1), rand[0,2), rand[0,3), etc
  public static ArrayList randNums(int numItems, int lo, int hi)
  {
